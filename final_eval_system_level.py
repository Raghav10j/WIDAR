...
for m in modelID:
	...
	with jsonlines.open('model_annotations.aligned.paired.jsonl') as reader:
		...
		if len(rougefscorelist)!=0:
			rougelistmodelwise.append(mean(rougefscorelist))
			print(rougelistmodelwise)
			coherencelistmodelwise.append(mean(coherencelist))
			# print(coherencelistmodelwise)
			consistencylistmodelwise.append(mean(consistencylist))
			# print(consistencylistmodelwise)
			fluencylistmodelwise.append(mean(fluencylist))
			# print(fluencylistmodelwise)
			relevancelistmodelwise.append(mean(relevancelist))
...
OGrougelistmodelwise=[]
OGcoherencelistmodelwise=[]
OGconsistencylistmodelwise=[]
OGfluencylistmodelwise=[]
OGrelevancelistmodelwise=[]
...
for m in modelID:
	...
	with jsonlines.open('model_annotations.aligned.scored.jsonl') as reader:
		...
		if len(OGrougefscorelist)!=0:
			OGrougelistmodelwise.append(mean(OGrougefscorelist))
			OGcoherencelistmodelwise.append(mean(OGcoherencelist))
			OGconsistencylistmodelwise.append(mean(OGconsistencylist))
			OGfluencylistmodelwise.append(mean(OGfluencylist))
			OGrelevancelistmodelwise.append(mean(OGrelevancelist))
...
# print('Kendall Rank correlation b/w coherence and our final rouge-1 recall: {:.3f}'.format(corr1))
# print('Kendall Rank correlation b/w coherence and OG rouge-1 recall: {:.3f}'.format(corr2))

# corr3,_=kendalltau(consistencylist,rougerecalllist)
# corr4,_=kendalltau(OGconsistencylist,OGrougerecalllist)
# print('Kendall Rank correlation b/w consistency and our final rouge-1 recall: {:.3f}'.format(corr3))
# print('kendall Rank correlation b/w consistency and OG rouge-1 recall: {:.3f}'.format(corr4))

# corr5,_=kendalltau(fluencylist,rougerecalllist)
# corr6,_=kendalltau(OGfluencylist,OGrougerecalllist)
# print('kenda rank correlation b/w fluency and our final rouge-1 recall: {:.3f}'.format(corr5))
# print('kenda rank correlation b/w fluency and OG rouge-1 recall: {:.3f}'.format(corr6))

# corr7,_=kendalltau(relevancelist,rougerecalllist)
# corr8,_=kendalltau(OGrelevancelist,OGrougerecalllist)
# print('kenda rank correlation b/w relevance and our final rouge-1 recall: {:.3f}'.format(corr7))
# print('kenda rank correlation b/w relevance and OG rouge-1 recall: {:.3f}'.format(corr8))

print('----------------fscore---------------')
corr1,_=kendalltau(coherencelistmodelwise,rougelistmodelwise)
corr2,_=kendalltau(OGcoherencelistmodelwise,OGrougelistmodelwise)
print('Kendall Rank correlation b/w coherence and our final rouge-1 fscore: {:.3f}'.format(corr1))
print('Kendall Rank correlation b/w coherence and OG rouge-1 fscore: {:.3f}'.format(corr2))

corr3,_=kendalltau(consistencylistmodelwise,rougelistmodelwise)
corr4,_=kendalltau(OGconsistencylistmodelwise,OGrougelistmodelwise)
print('Kendall Rank correlation b/w consistency and our final rouge-1 fscore: {:.3f}'.format(corr3))
print('kendall Rank correlation b/w consistency and OG rouge-1 fscore: {:.3f}'.format(corr4))

corr5,_=kendalltau(fluencylistmodelwise,rougelistmodelwise)
corr6,_=kendalltau(OGfluencylistmodelwise,OGrougelistmodelwise)
print('kenda rank correlation b/w fluency and our final rouge-1 fscore: {:.3f}'.format(corr5))
print('kenda rank correlation b/w fluency and OG rouge-1 fscore: {:.3f}'.format(corr6))

corr7,_=kendalltau(relevancelistmodelwise,rougelistmodelwise)
corr8,_=kendalltau(OGrelevancelistmodelwise,OGrougelistmodelwise)
print('kenda rank correlation b/w relevance and our final rouge-1 fscore: {:.3f}'.format(corr7))
print('kenda rank correlation b/w relevance and OG rouge-1 fscore: {:.3f}'.format(corr8))
